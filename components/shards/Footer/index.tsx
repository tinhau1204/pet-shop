...
function Footer({ className }: FooterProps) {
    return (
        <footer className={`${className} bg-yellow-light relative w-[100vw] left-[50%] right-[50%] mr-[-50vw] ml-[-50vw] sm:px-0 pt-10 md:pt-20 px-4 text-center rounded-t-2xl`}>
            <div className="base-container h-full">
                ...
                >
                    ...
                    >
                        {HeaderLink.map((link, index) => {
                            return (
                                <Text key={index} className="text-black font-semibold">{link.name}</Text>
                            )
                        })}
                    </Flex>
                ...
                <Divider my={{ base: '36px', sm: '40px' }} size="xs" className="border-gray-400" />
                ...
                <div className="grid place-content-center sm:grid-cols-12 items-center">
                    <div className="sm:col-span-3 w-full text-center sm:text-left order-3 sm:order-1">
                        <Text className="text-black-normal font-normal text-[10px] sm:text-sm">© 2022 Monito. All rights reserved.</Text>
                    </div>
                    ...
                    <Flex
                        ...
                        gap="xl"
                    >
                        <Text className="text-black-normal font-normal text-xs sm:text-sm">Terms of Service</Text>
                        <Text className="text-black-normal font-normal text-xs sm:text-sm">Privacy Policy</Text>
                    </Flex>
